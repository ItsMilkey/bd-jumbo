-- ************************************************************************************
-- SISTEMA DE GESTIÓN DE INVENTARIO - CARNICERÍA (MASTER SCRIPT V10 - FINAL FIX)
-- DESCRIPCIÓN: Corrección de nombre de variable (v_sup_central) en bloque final.
--              Script completo para Copy & Paste en APEX.
-- ************************************************************************************
...
BEGIN
    ...
    -- PRODUCTOS (1-33)
    INSERT ALL
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (1, 'Lomo Vetado', 1, 19990, 5.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (2, 'Asiento Picana', 1, 15500, 8.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (3, 'Entraña', 1, 22500, 3.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (4, 'Posta Negra', 1, 11990, 10.0, 2, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (5, 'Tapabarriga', 1, 13490, 6.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (6, 'Pechuga Entera', 2, 6990, 10.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_actual_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (7, 'Trutro Corto', 2, 4500, 15.0, 5.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (8, 'Alitas de Pollo', 2, 3990, 12.0, 4, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (9, 'Pollo Entero Faenado', 2, 3500, 8.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (10, 'Pulpa Pierna', 3, 7200, 7.5, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (11, 'Costillar Ahumado', 3, 9900, 4.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (12, 'Pechuga Pavo', 4, 8990, 5.0, 4, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (13, 'Filete Premium', 1, 24990, 8.0, 2, 1) 
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (14, 'Huachalomo', 1, 8990, 15.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (15, 'Abastero', 1, 9500, 12.0, 1, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (16, 'Chuleta Centro', 3, 6500, 10.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (17, 'Malaya de Cerdo', 3, 8500, 5.0, 2, 1) 
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (18, 'Chuleta Cordero', 5, 18990, 4.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (19, 'Osobuco', 1, 5990, 20.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (20, 'Posta Rosada', 1, 10500, 30.0, 2, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (21, 'Pechuga Fileteada', 2, 8500, 40.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (22, 'Lomo de Cerdo', 3, 7990, 25.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (23, 'Trutro Pavo', 4, 5200, 15.0, 4, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (24, 'Choclillo', 1, 9800, 15.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (25, 'Ganso', 1, 10990, 10.0, 2, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (26, 'Palanca', 1, 16990, 8.0, 1, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (27, 'Pata de Pollo', 2, 2990, 25.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (28, 'Carne Molida Pollo', 2, 4990, 15.0, 4, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (29, 'Pernil', 3, 5800, 20.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (30, 'Costilla de Cerdo', 3, 8500, 10.0, 2, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (31, 'Escalopa Pavo', 4, 9500, 6.0, 4, 2)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (32, 'Pierna Cordero', 5, 17500, 5.0, 2, 1)
        INTO productos_carne (producto_id, nombre, categoria_id, precio_por_kg, stock_minimo_kg, proveedor_id, supermercado_id) VALUES (33, 'Rack Cordero', 5, 25990, 3.0, 2, 1)
    SELECT 1 FROM DUAL;
